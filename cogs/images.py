...
PANEL_CHOICES = {
    ...
    "shop_moderation": "Заказы магазина «по запросу» (модерация)",
    "verify": "Привязка аккаунта сайта (/verify show)",
    "account": "Управление аккаунтом сайта (/account show)",
    "coins": "R-Coins: тикеты и модерация заявок",
    "announce": "Панель объявлений и биндов (/announce panel)",
